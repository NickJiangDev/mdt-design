...
const getOverflowOptions = (autoAdjustOverflow?: boolean | AdjustOverflow) => {
  if (typeof autoAdjustOverflow === 'boolean') {
    return autoAdjustOverflow ? autoAdjustOverflowEnabled : autoAdjustOverflowDisabled;
  }
  return { ...autoAdjustOverflowDisabled, ...autoAdjustOverflow };
};
...
const getPlacements = (config: PlacementsConfig) => {
  ...
  Object.keys(placementMap).forEach((key) => {
    placementMap[key] = config.arrowPointAtCenter
      ? { ...placementMap[key], overflow: getOverflowOptions(autoAdjustOverflow), targetOffset }
